...
class Ays_Pb_Public {
	...
	public function ays_generate_popup( $attr ){
        ...
        if(isset($popupbox['onoffswitch']) && $popupbox['onoffswitch'] == 'On'){
			...
			$ays_pb_action_buttons          = ($popupbox["action_button"] == false || $popupbox["action_button"] == '') ? "" : stripslashes( esc_attr($popupbox["action_button"]) ) ;
			...
			$ays_pb_bordercolor = (!isset($popupbox["bordercolor"])) ? "#000000" : stripslashes( esc_attr($popupbox["bordercolor"]) );
            $ays_pb_border_radius = (!isset($popupbox["border_radius"])) ? "4" : stripslashes( esc_attr($popupbox["border_radius"]) );
