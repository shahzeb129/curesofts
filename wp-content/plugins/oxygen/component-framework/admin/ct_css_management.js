function ovsbCSS() {
    return {
        ...
        setupCodemirror() {
            codeMirrorEditor = CodeMirror.fromTextArea(document.getElementById("#ovsb-css-codemirror"), {
                mode: 'css',
            ...
            codeMirrorEditor.setValue('Click a stylesheet to begin editing.');
            codeMirrorEditor.setSize('100%', '85vh');
            // setTimeout(function() {
            ...
            codeMirrorEditor.on('change', () => {
                    ...
                    thisSheet.css = this.utf8_to_b64(codeMirrorEditor.getValue());
                    thisSheet.modified = true;
                }
            )
        },
        updateCodeMirrorTheme() {
            codeMirrorEditor.setOption('theme', this.currentTheme);
            jQuery.post( ajaxurl, { 
                action: 'oxygen_set_codemirror_theme',
                theme: this.currentTheme,
                nonce: window.oxyNonceCodeMirror
            })
        },
        setupShortcuts() {
